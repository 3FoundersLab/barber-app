...
import { landingButtonLift, landingPrimaryCtaClass } from '@/components/landing/landing-classes'
  ...
  return (
    ...
    >
      <Button
        asChild
        variant="ghost"
        className={cn('h-12 w-full text-base', landingPrimaryCtaClass, landingButtonLift)}
      >
