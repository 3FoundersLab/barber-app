        ...
        <div className="flex flex-col gap-14 md:flex-row md:items-start md:justify-between md:gap-10">
            ...
            <ul className="mt-5 flex flex-col gap-2.5">
              {footerLinks.map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
                    className="text-sm text-zinc-600 transition-colors hover:text-amber-700 dark:text-zinc-400 dark:hover:text-amber-400"
                  >
                    {l.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <p className="mt-5 text-sm text-zinc-600 dark:text-zinc-400">
              <a href="mailto:contato@barberapp.com.br" className="hover:text-amber-700 dark:hover:text-amber-400">
