...
-- Dono do painel (profiles.role = admin) pode atualizar a barbearia à qual está vinculado
-- (qualquer papel em barbearia_users; o app resolve acesso por membro, não só bu.role = admin)
