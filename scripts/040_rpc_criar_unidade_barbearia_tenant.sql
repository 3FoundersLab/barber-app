-- Nova unidade pelo admin do tenant: cria barbearia + vínculo + assinatura alinhada à unidade de referência.
-- Mesma regra de permissão que update_barbearia_dados_tenant (admin membro OU super_admin).
--
-- Pré-requisitos: barbearias.status_cadastro, assinaturas.periodicidade (scripts 022, 026).
